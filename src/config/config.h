...
// added task names
#define MAIN_CONTROL_TASK_NAME	"MAIN_CONTROL"
#define REF_GENERATOR_TASK_NAME	"REFERENCE_GENERATOR"
#define MODE_SWITCH_TASK_NAME  	"MODE_SWITCH"
...
#define MAIN_CONTROL_TASK_STACKSIZE 	configMINIMAL_STACK_SIZE
#define REF_GENERATOR_TASK_STACKSIZE  	configMINIMAL_STACK_SIZE
#define MODE_SWITCH_TASK_STACKSIZE      configMINIMAL_STACK_SIZE
